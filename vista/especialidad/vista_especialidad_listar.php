        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingrese especidalidad" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text"  id="txt_especialidad_actual_editar" placeholder="Ingrese especidalidad" maxlength="50" onkeypress="return soloLetras(event)"  hidden><br>
                    <label for="">Nombre</label> <!-- body del modal -->
                    <input type="text" class="form-control" id="txt_especialidad_nueva_editar" placeholder="Ingrese especidalidad" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
